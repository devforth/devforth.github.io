...
> Guide to using AdminForth without a direct database connection: write a custom data source connector which reads and modifies data through your own GraphQL, REST, or JSON-RPC API.
